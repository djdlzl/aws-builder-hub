...
const instances: EC2Instance[] = [
  { id: "i-0abc123def", name: "web-server-prod-01", type: "t3.medium", status: "running", publicIp: "54.180.123.45", privateIp: "10.0.1.10", az: "ap-northeast-2a" },
  { id: "i-0def456ghi", name: "api-server-prod-01", type: "t3.large", status: "running", publicIp: "54.180.123.46", privateIp: "10.0.1.11", az: "ap-northeast-2b" },
  { id: "i-0ghi789jkl", name: "worker-staging-01", type: "t3.small", status: "stopped", publicIp: "-", privateIp: "10.0.2.10", az: "ap-northeast-2c" },
  { id: "i-0jkl012mno", name: "batch-server-01", type: "c5.xlarge", status: "running", publicIp: "54.180.123.47", privateIp: "10.0.1.12", az: "ap-northeast-2a" },
];
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">가상 서버 인스턴스를 관리합니다</p>
        </div>
              ...
              <div className="grid gap-2">
                ...
                <Select value={instanceType} onValueChange={setInstanceType}>
                  ...
                  <SelectContent className="bg-popover border-border">
                    <SelectItem value="t3.micro">t3.micro (1 vCPU, 1GB)</SelectItem>
                    <SelectItem value="t3.small">t3.small (2 vCPU, 2GB)</SelectItem>
                    <SelectItem value="t3.medium">t3.medium (2 vCPU, 4GB)</SelectItem>
                    <SelectItem value="t3.large">t3.large (2 vCPU, 8GB)</SelectItem>
                    <SelectItem value="c5.xlarge">c5.xlarge (4 vCPU, 8GB)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="grid gap-2">
                ...
                <Select value={selectedModule} onValueChange={setSelectedModule}>
                  ...
                  <SelectContent className="bg-popover border-border">
                    ...
                    <SelectItem value="ec2-standard-options">ec2-standard-options</SelectItem>
                  </SelectContent>
                </Select>
              </div>
          ...
          <tbody className="divide-y divide-border">
            {instances.map((instance) => (
              <tr key={instance.id} className="hover:bg-accent/50 transition-colors">
                ...
                <td className="px-4 py-4">
                  <code className="text-sm font-mono text-foreground">{instance.publicIp}</code>
                </td>
                <td className="px-4 py-4">
                  <code className="text-sm font-mono text-muted-foreground">{instance.privateIp}</code>
                </td>
                <td className="px-4 py-4">
