...
import MandatoryTagKeySettings from "@/components/settings/MandatoryTagKeySettings";
...
export default function AWSAccounts() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Admin 설정</h1>
        <p className="text-muted-foreground mt-1">
          관리자 전용 설정과 계정 관리를 진행합니다.
        </p>
      </div>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Assume Role을 통해 다른 AWS 계정의 리소스에 접근할 수
                  있습니다.
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 mt-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    추가 보안이 필요한 경우에만 사용하세요. 비워두면 External ID
                    없이 연결됩니다.
                  </p>
                </div>
                  ...
                  <TableCell>
                    <div className="flex items-center justify-end gap-2">
                      ...
                      >
                        <RefreshCw
                          className={`h-4 w-4 ${
                            isVerifying === account.id ? "animate-spin" : ""
                          }`}
                        />
                      </Button>
                      <Button
